...
3. **テキスト**を入力（改行可）
4. **「SVGをコピー」** → PowerPoint で <kbd>⌘</kbd>+<kbd>V</kbd>
   - Mac PPTでペーストできない場合は **「SVGをダウンロード」** → .svg をスライドにドラッグ&ドロップ
5. PPT で貼り付いた SVG を**右クリック → 「シェイプに変換」**
6. 選択したシェイプを縦横に**非比例スケール** → 長体・平体完成
